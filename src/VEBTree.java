public class VEBTree
{
	...
	public static VEBTree createVEBTree(int universeSize)
	{
		...
		{
			System.out.println("ERROR: The tree must be created with the universe size as a power of 2 !!!!!");
			return null;
		}
	}	
	
	//the folling functions are the only visible functions implementing OOPs.
	...
	//following are the private functions with the inner functioning not usable by the user.

	
	//Creates the tree structure with a universesize of size universeSize.
	private VEBTree(int universeSize)
	{
		//This node will handle creating all the other nodes, and the full tree will be built.
